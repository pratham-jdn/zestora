    ...
    >
      ...
      >
        ...
        <p className="text-gray-600 mb-8">
          Sign In to your account to get started with delicious recipes
        </p>
        ...
        <button
          className={`w-full mt-4 flex items-center justify-center gap-2 border rounded-lg px-3 py-2 transition-duration-200 bg-[#ff4d2d] text-white hover:bg-[#e64323] cursor-pointer`} onClick={handleSignIn} disabled={loading}
        >
        ...
        <p className="text-center mt-3 cursor-pointer" onClick={()=>navigate("/signup")}>Don't have an account? <span className="text-[#ff4d2d]">Sign Up</span></p>
      </div>
    </div>
  );
};

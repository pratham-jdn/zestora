...
const CreateEditShop = () => {
  ...
  const handleSubmit = async (e)=>{
    ...
    try {
      ...
      console.log("Error creating/editing shop:", error);
      setLoading(false)
    }
  }
  ...
  return (
    <div className="flex justify-center flex-col items-center p-6 bg-linear-to-br from-orange-50 relative to-white min-h-screen">
      <div
        ...
        onClick={() => navigate("/")}
      >
        <IoArrowBack size={25} className="text-[#ff4d2d]" />
      </div>
        ...
        <form className="space-y-5" onSubmit={handleSubmit}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" placeholder="Enter City" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500"
            ...
            <div>
              ...
              <input type="text" placeholder="Enter State" className="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500"

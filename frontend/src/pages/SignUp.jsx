    ...
    >
      ...
      >
        ...
        <p className="text-gray-600 mb-8">
          Create your account to get started with delicious recipes
        </p>
        ...
        <p className="text-center mt-3 cursor-pointer" onClick={()=>navigate("/signin")}>Already have an account? <span className="text-[#ff4d2d]">Sign In</span></p>
      </div>
    </div>
  );
};
